...
var AuthStateMixin = _Vue__default['default'].extend({
    data: function () {
        return {
...
var NavigationGuardMixin = _Vue__default['default'].extend({
...
var script = _Vue__default['default'].extend({
    name: 'LoginCallback',
    beforeMount: function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.$auth.handleLoginRedirect()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
exports.NavigationGuardMixin = NavigationGuardMixin;
